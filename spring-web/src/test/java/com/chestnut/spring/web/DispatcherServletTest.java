...
import com.chestnut.spring.web.controller.ControllerConfiguration;
import com.chestnut.spring.web.controller.ApiController.SigninObj;
...
public class DispatcherServletTest {
    ...
    PropertyResolver createPropertyResolver() {
        ...
        ps.put("spring.web.favicon-path", "/icon/favicon.ico");
        ps.put("spring.web.freemarker.template-path", "/WEB-INF/templates");
